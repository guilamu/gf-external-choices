...
/**
 * Class GF_External_Choices_GitHub_Updater
 *
...
class GF_External_Choices_GitHub_Updater
{
     ...
     * @var string
     */
    private const GITHUB_REPO = 'gf-external-choices';
     ...
     * @var string
     */
    private const PLUGIN_FILE = 'gf-external-choices/gf-external-choices.php';
     ...
     * @var string
     */
    private const PLUGIN_SLUG = 'gf-external-choices';
     ...
     * @var string
     */
    private const PLUGIN_NAME = 'Gravity Forms External Choices';
     ...
     * @var string
     */
    private const PLUGIN_DESCRIPTION = 'Populate Gravity Forms Multiple Choice fields from external CSV, JSON, or XLSX data sources.';
     ...
     * @var string
     */
    private const TEXT_DOMAIN = 'gf-external-choices';
     ...
     * @var string
     */
    private const CACHE_KEY = 'gf_external_choices_github_release';
     ...
     *
     * Prefers custom release assets (e.g., gf-external-choices.zip) over
...
// Initialize the updater
GF_External_Choices_GitHub_Updater::init();
